...
class OC_App {
	...
	public static function loadApp(string $app) {
		...
		$adminData = $info['settings']['admin'];
		if (!empty($adminData)) {
			if (array_key_exists('@value', $adminData)) {
				\OC::$server->get(ISettingsManager::class)->registerSetting('admin', $adminData['@value'], filter_var($adminData['@attributes']['allow-privilege-delegation'], FILTER_VALIDATE_BOOLEAN));
			} else {
				foreach ($adminData as $setting) {
					if (is_array($setting)) {
